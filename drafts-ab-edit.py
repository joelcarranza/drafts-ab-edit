...
"""
drafts-ab-edit.py is a python script for manipulating the Action Backups 
generated by the Drafts iOS app. Use it to easily setup Dropbox Actions 
from the comfort of your OSX terminal.

For more info:

	drafts-ab-edit.py --help 
"""
